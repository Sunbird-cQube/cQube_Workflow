...
const sttendanceRoutes: Routes = [
  {
    path: '', canActivate: [AuthGuard], children: [
      {
        path: 'student-attendance', component: StudengtAttendanceComponent, canActivateChild: [AuthGuard], data: ['admin', 'viewer']
      },
      {
        path: 'teacher-attendance', component: TeacherAttendanceComponent, canActivateChild: [AuthGuard], data: ['admin', 'viewer']
      },
      {
        path: 'student-attendance-chart', component: StudentAttendanceChartComponent, canActivateChild: [AuthGuard], data: ['admin', 'viewer']
      }
    ]
  }
]
