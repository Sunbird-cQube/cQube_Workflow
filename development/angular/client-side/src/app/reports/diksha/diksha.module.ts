...
const dikshaRoutes: Routes = [
  {
    path: '', canActivate: [AuthGuard], children: [
      {
        path: 'usage-by-user-profile', component: DikshaChartComponent, canActivateChild: [AuthGuard], data: ['admin', 'viewer']
      },
      {
        path: 'usage-by-course-content', component: DikshaTableComponent, canActivateChild: [AuthGuard], data: ['admin', 'viewer']
      },
      {
        path: 'usage-by-course', component: DikshaBarChartComponent, canActivateChild: [AuthGuard], data: ['admin', 'viewer']
      },
      {
        path: 'usage-by-textbook', component: DikshaUsageByTextBookComponent, canActivateChild: [AuthGuard], data: ['admin', 'viewer']
      },
      {
        path: 'usage-by-textbook-content', component: UsageByTextbookContentComponent, canActivateChild: [AuthGuard], data: ['admin', 'viewer']
      },
      {
        path: 'tpd-course-progress', component: DikshaTPDContentProgressComponent, canActivateChild: [AuthGuard], data: ['admin', 'viewer']
      },
      {
        path: 'tpd-teacher-percentage', component: DikshaTPDTeachersPercentageComponent, canActivateChild: [AuthGuard], data: ['admin', 'viewer']
      },
      {
        path: 'tpd-enrollment', component: DikshaTpdEnrollmentComponent, canActivateChild: [AuthGuard], data: ['admin', 'viewer']
      },
      {
        path: 'tpd-completion', component: DikshaTpdCompletionComponent, canActivateChild: [AuthGuard], data: ['admin', 'viewer']
      }
    ]
  }
]
