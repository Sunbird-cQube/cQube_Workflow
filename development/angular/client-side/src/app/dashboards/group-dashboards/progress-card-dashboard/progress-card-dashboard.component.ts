...
@Component({
  ...
  templateUrl: './progress-card-dashboard.component.html',
  styleUrls: ['./progress-card-dashboard.component.css']
})
export class ProgressCardDashboardComponent implements OnInit {
  state;
  reportGroup = "Progress Card"
