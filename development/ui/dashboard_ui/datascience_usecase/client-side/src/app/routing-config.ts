...
import { DashboardComponent } from './dashboards/datascience_usecase/dashboard.component';
...
export var routes: Routes = routes = [
    ...
    },
    {
        path: '', component: HomeComponent, canActivate: [AuthGuard], children: [
            ...
            {
                path: 'datascience', loadChildren: () => import('./reports/data-science/data-science.module').then(m => m.DataScienceModule)
            },
            {
