...
var routes: Routes = [
  ...
  },
  {
    path: '', component: HomeComponent, canActivate: [AuthGuard], data: ['admin', 'report_viewer', 'all'], children: [
      ...
      {
        path: 'datascience', canActivateChild: [AuthGuard], data: ['admin', 'report_viewer', 'all'], loadChildren: () => import('./reports/data-science/data-science.module').then(m => m.DataScienceModule)
      },
      {
