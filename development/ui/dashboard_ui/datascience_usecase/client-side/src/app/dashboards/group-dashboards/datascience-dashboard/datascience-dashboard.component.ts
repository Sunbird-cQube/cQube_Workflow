...
@Component({
  selector: 'app-datascience-dashboard',
  templateUrl: './datascience-dashboard.component.html',
  styleUrls: ['./datascience-dashboard.component.css']
})
export class DatascienceDashboardComponent implements OnInit {
  state;
  reportGroup = "Datascience"
  //tooltip texts::::::::::::::
  ...
  assignViews(views) {
    ...
    views.forEach((element) => {
      ...
      if (element.reportid == "anomaly") {
        this.anomalyViews = element.number_of_views + " (" + timeStr + ")";
      }
      if (element.reportid == "dropout") {
        this.dropoutViews = element.number_of_views + " (" + timeStr + ")";
      }
