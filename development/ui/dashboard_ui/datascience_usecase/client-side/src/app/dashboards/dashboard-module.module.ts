...
import { DatascienceDashboardComponent } from './group-dashboards/datascience-dashboard/datascience-dashboard.component';
...
var dashboardRoutes: Routes = [
  {
    path: '', canActivate: [AuthGuard], data: ['admin', 'report_viewer'], children: [
      ...
      {
        path: 'datascience-dashboard', component: DatascienceDashboardComponent
      },
      {
