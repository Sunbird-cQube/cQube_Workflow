...
export const dashboardReportDescriptions = {
    ...
    dccTooltip: "This dashboard provides insight on district-wise usage of courses",
    ...
    tpdtpTooltip: "This dashboard provides details on district-wise course enrolment progress broken at the individual course level.",
    tpdcpTooltip: "This dashboard provides details on district-wise course enrolment progress broken at the individual course level.",
    ...
    gpsOfLearningTPDTooltip: "The dashboard provides details on the total content plays for Courses by location for" + " " + state + ".",
    ...
    userOnboarding: "The dashboards provides insights on the user onboarding progress across various courses for" + " " + state + " " + " over time",
    userProgress: "The dashboard provides insights on user progress completion and certification across various courses for" + " " + state + " " + ".",
    userEngagement: "The dashboard provides insights on user engagement for various courses for" + " " + state + ".",
