...
NIFI_INPUT_OUTPUT_PORTS = {
    ...
    'udise_transformer': [{'OUTPUT_PORT': 'split_wait_output', 'INPUT_PORT': 'split_wait'},
    ...
    'teacher_attendance_transformer': [
      ...
      'pat_transformer': [{'OUTPUT_PORT': 'pat_split_wait', 'INPUT_PORT': 'split_wait'},
       ...
       'cqube_telemetry_transformer': [{'OUTPUT_PORT': 'cqube_telemetry_split_wait', 'INPUT_PORT': 'split_wait'},
    ...
    'cQube_data_storage': {'static_data_transformer': [{'OUTPUT_PORT': 'static_files', 'INPUT_PORT': 'static_data_input'}],
                           ...
                           'udise_transformer': [{'OUTPUT_PORT': 'udise_zip_output', 'INPUT_PORT': 'udise_zip_wait_success_in'},
