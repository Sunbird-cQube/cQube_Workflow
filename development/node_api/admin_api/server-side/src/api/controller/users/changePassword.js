...
router.post('/:id', auth.authController, async function (req, res) {
    ...
    // try {
    //     logger.info('---change password api ---');
    //     var usersUrl = `${host}/auth/realms/${realm}/account/credentials/password`;
    //     var headers = {
    ...
    //     }
    //     var newPass = {
    //         currentPassword: req.body.currentPasswd,
    //         newPassword: req.body.cnfpass,
    //         confirmation: req.body.cnfpass
    //     };
