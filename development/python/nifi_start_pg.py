...
if __name__ == "__main__":
    ...
    sys arguments = 1.  processor group name . Run this code after installing required data sources, starts the processor group.
    Ex: python nifi_start_pg.py.py cqube_telemetry_transformer
    """
